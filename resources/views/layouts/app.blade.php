            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a class="btn btn-primary mr-2" href="{{ route('showQuizesICreated') }}" >Quizes I Created</a>
                        <li class="nav-item dropdown">        
                        <a id="navbarDropdown" class="nav-link dropdown-toggle btn btn-success" 
                                href="{{ route('myQuizes') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
        ...
        <div class="container">
          <div class="text-muted">
            <ul style="list-style: none; display: flex;">
              ...
              <a class="btn btn-primary" href="{{ route("playCustomQuizGet") }}" style="position: fixed;bottom: 5px;right: 15px;z-index: 9999;">Enter Code</a>
            </ul>
          </div>
